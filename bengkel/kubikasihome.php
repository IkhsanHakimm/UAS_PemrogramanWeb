...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Data Kubikasi</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Tabel Kubikasi</li>
                        </ol>
                        <div class="container">
        <br>
        <?php
        ...
        <table class="my-3 table table-bordered">
            ...
            while ($data = mysqli_fetch_array($hasil)) {
                ...
                <tr>
                    ...
                    <td>
                        <a href="updatekubikasi.php?id_kubikasi=<?php echo htmlspecialchars($data['id_kubikasi']); ?>" class="btn btn-warning" role="button">Update</a>
        ...
        <a href="createkubikasi.php" class="btn btn-primary" role="button">Tambah Data</a>
    </div>
                </main>
